...
import { blankSamples, expectNeverBlankAfterFirstPaint, sampleRender, seedSession, } from "./utils/render-probe";
/**
...
test.describe("Homepage — nunca fica em branco", () => {
    ...
    test("initial render never shows a blank screen", async ({ page }) => {
        ...
        expect(consoleErrors.filter((e) => /Minified React error|is not defined|Cannot read/i.test(e)), "fatal runtime errors during homepage render").toHaveLength(0);
    });
