...
BEGIN
    ...
    SELECT customer_id, current_status INTO _session_record 
    FROM public.walk_sessions WHERE id = _session_id;
...
BEGIN
    ...
    SELECT pin_hash, attempts, expires_at INTO _code_record 
    FROM public.walk_pickup_codes WHERE session_id = _session_id FOR UPDATE;
