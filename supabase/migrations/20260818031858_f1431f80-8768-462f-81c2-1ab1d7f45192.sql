-- Phase 4.2 Patch 1C: Final Reconciliation (Hardening walker_tracking & append_walk_tracking_point)
-- Correcting last_sync_at column name if it doesn't exist (using last_sync instead, which is standard in this project)
...
BEGIN
    ...
    IF _profile.current_walk_id IS NOT NULL THEN
        ...
        IF _is_active_session THEN
            ...
            -- Log record (Column name is walk_session_id)
