...
CREATE TABLE public.locations (
    -- Foreign key for user_id would be auth.users(id)
    address text,
    city text,
    created_at timestamp with time zone DEFAULT now(),
    id uuid PRIMARY KEY DEFAULT gen_random_uuid(),
    is_default boolean DEFAULT false,
    latitude timestamp with time zone,
...
CREATE TABLE public.petwalker_earnings (
    ...
    petwalker_id uuid NOT NULL,
    platform_fee timestamp with time zone NOT NULL,
...
CREATE TABLE public.petwalker_profiles (
    ...
    cancellation_rate timestamp with time zone,
    ...
    public_bio text,
    rating_average timestamp with time zone,
...
CREATE TABLE public.profiles (
    -- Foreign key for id would be auth.users(id)
    age integer DEFAULT 0,
    avatar_url timestamp with time zone,
    bio text,
    birthday text,
...
CREATE TABLE public.walk_sessions (
    actual_duration_minutes timestamp with time zone,
    created_at timestamp with time zone DEFAULT now() NOT NULL,
    customer_id uuid NOT NULL,
    distance_km numeric(10,2) DEFAULT 0.00,
    end_time timestamp with time zone,
    feedback text,
    home_location timestamp with time zone,
    id uuid PRIMARY KEY DEFAULT gen_random_uuid(),
    local_stops jsonb,
    pet_id uuid NOT NULL,
    planned_duration_minutes timestamp with time zone NOT NULL,
    rating timestamp with time zone,
    route_coordinates timestamp with time zone,
